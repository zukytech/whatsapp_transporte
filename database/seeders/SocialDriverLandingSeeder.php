...
class SocialDriverLandingSeeder extends Seeder
{
    ...
    public function run()
    {
        $posts = [
            ...
            ['post_type'=>'faq','title'=>'{"en":"¿Como me pagan?"}', 'description'=>'{"en":"El cliente puede pagarte al final del viaje en efectivo o con carrito, PayPal o MercadoPago"}'],
            ['post_type'=>'faq','title'=>'{"en":"¿Puedo rechazar el viaje solicitado?"}', 'description'=>'{"en":"Sí, puede rechazar el viaje según sus preferencias. El cliente será informado"}'],
            ['post_type'=>'faq','title'=>'{"en":"Soy conductor individual. ¿Puedo usar el plan de empresa?"}', 'description'=>'{"en":"Sí, puede suscribirse a cualquier plan ofrecido."}'],
        ];
